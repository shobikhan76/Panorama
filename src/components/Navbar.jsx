  ...
  return (
    <>
      ...
      >
        ...
        <Link
          to="/"
          className="logo font-['Playfair_Display'] text-2xl font-bold text-white flex items-center gap-3 transition-all duration-300 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] hover:scale-102"
        >
